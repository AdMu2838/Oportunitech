...
import 'list_tests_model.dart';
export 'list_tests_model.dart';

class ListTestsWidget extends StatefulWidget {
  const ListTestsWidget({super.key});

  @override
  State<ListTestsWidget> createState() => _ListTestsWidgetState();
}

class _ListTestsWidgetState extends State<ListTestsWidget> {
  late ListTestsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListTestsModel());
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            24.0, 4.0, 0.0, 0.0),
                                        child: Text(
                                          'Dile a los reclutadores tu capacidad',
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        12.0, 4.0, 12.0, 16.0),
                                                child: Text(
                                                  'Aqui se medira su capacidad, con preguntas generados por IA, muy personalizadas.',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                                      .override(

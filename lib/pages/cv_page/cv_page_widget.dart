...
class _CvPageWidgetState extends State<CvPageWidget> {
  ...
  void initState() {
    ...
    _model.descriptionFocusNode3!.addListener(() => safeSetState(() {}));
    _model.descriptionTextController4 ??= TextEditingController();
    _model.descriptionFocusNode4 ??= FocusNode();
    _model.descriptionFocusNode4!.addListener(() => safeSetState(() {}));
        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                'Complete los campos para crear su CV',
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Enumere sus habilidades',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            fontFamily: 'Outfit',
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          'Detalle su formacion academica',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            fontFamily: 'Outfit',
                                      ...
                                      filled: true,
                                      fillColor: (_model.descriptionFocusNode3
                                                  ?.hasFocus ??
                                              false)
                                          ? const Color(0x4D9489F5)
                                          : Colors.white,
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          'Adaptaciones en su area de trabajo',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                                            fontFamily: 'Figtree',
                                      ...
                                      filled: true,
                                      fillColor: (_model.descriptionFocusNode4
                                                  ?.hasFocus ??
                                              false)
                                          ? const Color(0x4D9489F5)
                                          : Colors.white,

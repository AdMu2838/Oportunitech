...
import 'work_preferences_model.dart';
export 'work_preferences_model.dart';
...
class _WorkPreferencesWidgetState extends State<WorkPreferencesWidget> {
  late WorkPreferencesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkPreferencesModel());

...
class CvCopyWidget extends StatefulWidget {
  ...
  ///
  /// Profile Picture Upload: Display as a round preview.
  /// Residence Information: Dropdowns for department, province, and district
  /// (Peru-specific).
  /// Languages: Addable list with proficiency level options.
  /// Upload CV: Buttons for importing from LinkedIn or PortalEmpleo (Peru);
  /// alternative for creating a personalized CV.
  /// Skills and Knowledge: Addable dynamic list for input.
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FlutterFlowDropDown<String>(
                            ...
                            options: const ['Arequipa', 'Cuzco', 'Lima'],
                            onChanged: (val) =>
                          ...
                          FlutterFlowDropDown<String>(
                            controller: _model.dropDownValueController2 ??=
                                FormFieldController<String>(null),
                            options: const ['Lima', 'Callao', 'Arequipa'],
                            onChanged: (val) =>
                          ...
                          FlutterFlowDropDown<String>(
                            controller: _model.dropDownValueController3 ??=
                                FormFieldController<String>(null),
                            options: const ['San Borja', 'Callao', 'Miraflores'],
                            onChanged: (val) =>
